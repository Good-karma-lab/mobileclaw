...
class RuntimeBootReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // Start Guappa agent service on boot
        val guappaIntent = Intent(context, GuappaAgentService::class.java)
        ContextCompat.startForegroundService(context, guappaIntent)
    }
}
